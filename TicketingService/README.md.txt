...
7 - The SeatHold object probably has an id associated with it, that is generated by a sequence. Additionally, the SeatHold object is also
    ...
    if they're temporarily being on hold or reserved initially.
	Therefore, if a seat is being placed on hold, the seatHold object will be deleted after three seconds if not chosen to commit to that.
