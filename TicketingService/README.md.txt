...
2 - The seats are individually distinguished by some sort of identifier, whether it be a number/letter combination (for example, A1, A2, A3), or by a number (01, 02, 03, 04).
